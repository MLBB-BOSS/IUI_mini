...
# 🔽 ВИПРАВЛЕНО: Імпортуємо правильні, готові класи для інструментів
...
class GeminiSearch:
    ...
    """
    def __init__(self):
        # 🔽 ВИПРАВЛЕНО: Використовуємо готовий клас для інструменту, а не збираємо вручну
        self.search_tool = Tool(google_search=GoogleSearchRetrieval())
