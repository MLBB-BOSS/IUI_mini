...
async def cmd_start(message: Message) -> None:
    """Привітання користувача з динамічним звертанням."""
...
Просто напиши своє запитання після команди <code>/go</code>

<b>🚀 Приклади:</b>
• <code>/go як покращити макро гру?</code>
• <code>/go як грати в команді?</code>
• <code>/go на кого краще піти в джанглі?</code>
• <code>/go що таке роум і як ним грати?</code>
• <code>/go кого брати проти Ланселота?</code>

Готовий стати твоїм найкращим тіммейтом у MLBB! 💪✨
"""

    await message.answer(welcome_text)
    logger.info(f"✅ Привітання надіслано для {user_name}")
...
async def cmd_go(message: Message) -> None:
    ...
    if not user_query:
        await message.reply(
            ...
            "<i>Приклад: /go як краще фармити в джанглі?</i>"
        )
        return
