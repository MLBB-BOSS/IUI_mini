...
Твоя експертна відповідь (дотримуйся ВСІХ стандартів вище, особливо щодо конкретних прикладів героїв):"""
    ...
    async def get_response(self, user_name: str, user_query: str) -> str:
        ...
        payload = {
            ...
            "max_tokens": 1000, # Трохи збільшимо, так як відповіді стануть детальнішими
            "temperature": 0.65, # Зменшимо трохи для більшої точності з конкретними героями
            "top_p": 0.9,
            "presence_penalty": 0.1,
            "frequency_penalty": 0.15 # Трохи збільшимо, щоб стимулювати різноманітність героїв
        }
