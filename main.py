...
Структура JSON повинна бути такою:
{
  ...
  "current_rank": "string (наприклад, 'Епічний V', 'Легенда III', 'Міфічний 24 зірки') або null",
  "highest_rank_season": "string (наприклад, 'Міфічна Слава 50 зірок') або null",
...
Для рангів, якщо бачиш римські цифри та зірки, вказуй їх (наприклад, "Міфічний III", "Легенда V 2 зірки").
Якщо бачиш "Highest Rank" з цифрою біля зірки (наприклад, 24 біля іконки Міфічної Слави), це "highest_rank_season".
Поле "current_rank" має відображати поточний ранг, який зазвичай показаний більшою іконкою.
"""
