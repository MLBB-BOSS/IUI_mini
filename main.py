...
# ---- Реєстрація роутерів ----
from handlers.party_handlers import register_party_handlers  # РЕЄСТРУЄМО ПЕРШИМ!
...
from handlers.general_handlers import cmd_go  # Для передачі в vision_handlers
...
async def main() -> None:
    ...
    # ---- ВАЖЛИВО: спочатку party_handlers, потім general_handlers ----
    register_party_handlers(dp)            # <-- Реєструємо ПЕРШИМ!
    register_general_handlers(dp)          # <-- Цей вже після нього
