...
CONVERSATIONAL_TRIGGERS: dict[str, str] = {
    ...
    # Про самого бота
    "що ти вмієш": "Розкажи коротко про свої основні функції: аналіз скріншотів, поради по грі та допомога у зборі паті. Нагадай, що ти GGenius.",
    "хто тебе створив": "Відповідай з повагою та гумором, що ти — результат праці та генія MLBB-BOSS, створений для допомоги спільноті.",
